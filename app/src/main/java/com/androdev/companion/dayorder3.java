...
public class dayorder3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dayorder3);
        ...
        SharedPreferences class2 = getSharedPreferences("class3", MODE_PRIVATE);
        SharedPreferences pref2 = getSharedPreferences("day3", MODE_PRIVATE);
        sub1.setText(pref2.getString("hour1", "N/A") + " - " + class2.getString("class1", ""));
        sub2.setText(pref2.getString("hour2", "N/A") + " - " + class2.getString("class2", ""));
        sub3.setText(pref2.getString("hour3", "N/A") + " - " + class2.getString("class3", ""));
        sub4.setText(pref2.getString("hour4", "N/A") + " - " + class2.getString("class4", ""));
        sub5.setText(pref2.getString("hour5", "Lunch"));
        sub6.setText(pref2.getString("hour6", "N/A") + " - " + class2.getString("class6", ""));
        sub7.setText(pref2.getString("hour7", "N/A") + " - " + class2.getString("class7", ""));
        sub8.setText(pref2.getString("hour8", "N/A") + " - " + class2.getString("class8", ""));
        sub9.setText(pref2.getString("hour9", "N/A") + " - " + class2.getString("class9", ""));
        sub10.setText(pref2.getString("hour10", "N/A") + " - " + class2.getString("class10", ""));
