...
public class dayorder4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dayorder4);
        ...
        SharedPreferences class4 = getSharedPreferences("class4", MODE_PRIVATE);
        SharedPreferences pref4 = getSharedPreferences("day4", MODE_PRIVATE);
        sub1.setText(pref4.getString("hour1", "N/A") + " - " + class4.getString("class1", ""));
        sub2.setText(pref4.getString("hour2", "N/A") + " - " + class4.getString("class2", ""));
        sub3.setText(pref4.getString("hour3", "N/A") + " - " + class4.getString("class3", ""));
        sub4.setText(pref4.getString("hour4", "N/A") + " - " + class4.getString("class4", ""));
        sub5.setText(pref4.getString("hour5", "Lunch"));
        sub6.setText(pref4.getString("hour6", "N/A") + " - " + class4.getString("class6", ""));
        sub7.setText(pref4.getString("hour7", "N/A") + " - " + class4.getString("class7", ""));
        sub8.setText(pref4.getString("hour8", "N/A") + " - " + class4.getString("class8", ""));
        sub9.setText(pref4.getString("hour9", "N/A") + " - " + class4.getString("class9", ""));
        sub10.setText(pref4.getString("hour10", "N/A") + " - " + class4.getString("class10", ""));
