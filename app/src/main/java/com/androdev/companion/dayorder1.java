...
public class dayorder1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dayorder1);
        ...
        SharedPreferences class0 = getSharedPreferences("class1",MODE_PRIVATE);
        SharedPreferences pref = getSharedPreferences("day1",MODE_PRIVATE);
        sub1.setText(pref.getString("hour1","N/A")+" - "+class0.getString("class1",""));
        sub2.setText(pref.getString("hour2","N/A")+" - "+class0.getString("class2",""));
        sub3.setText(pref.getString("hour3","N/A")+" - "+class0.getString("class3",""));
        sub4.setText(pref.getString("hour4","N/A")+" - "+class0.getString("class4",""));
        sub5.setText(pref.getString("hour5","Lunch"));
        sub6.setText(pref.getString("hour6","N/A")+" - "+class0.getString("class6",""));
        sub7.setText(pref.getString("hour7","N/A")+" - "+class0.getString("class7",""));
        sub8.setText(pref.getString("hour8","N/A")+" - "+class0.getString("class8",""));
        sub9.setText(pref.getString("hour9","N/A")+" - "+class0.getString("class9",""));
        sub10.setText(pref.getString("hour10","N/A")+" - "+class0.getString("class10",""));
