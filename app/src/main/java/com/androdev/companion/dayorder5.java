...
public class dayorder5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dayorder5);
        ...
        SharedPreferences class5 = getSharedPreferences("class5",MODE_PRIVATE);
        SharedPreferences pref5 = getSharedPreferences("day5",MODE_PRIVATE);
        sub1.setText(pref5.getString("hour1","N/A")+" - "+class5.getString("class1",""));
        sub2.setText(pref5.getString("hour2","N/A")+" - "+class5.getString("class2",""));
        sub3.setText(pref5.getString("hour3","N/A")+" - "+class5.getString("class3",""));
        sub4.setText(pref5.getString("hour4","N/A")+" - "+class5.getString("class4",""));
        sub5.setText(pref5.getString("hour5","Lunch"));
        sub6.setText(pref5.getString("hour6","N/A")+" - "+class5.getString("class6",""));
        sub7.setText(pref5.getString("hour7","N/A")+" - "+class5.getString("class7",""));
        sub8.setText(pref5.getString("hour8","N/A")+" - "+class5.getString("class8",""));
        sub9.setText(pref5.getString("hour9","N/A")+" - "+class5.getString("class9",""));
        sub10.setText(pref5.getString("hour10","N/A")+" - "+class5.getString("class10",""));
